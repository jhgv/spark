...
public class RequestResponseFactory_ESTest extends RequestResponseFactory_ESTest_scaffolding {
  ...
  public void test0()  throws Throwable  {
      ...
      doReturn("spark.RequestResponseFactory").when(routeMatch0).getMatchUri();
      doReturn("spark.RequestResponseFactory").when(routeMatch0).getRequestURI();
  ...
  public void test3()  throws Throwable  {
      HttpServletRequest httpServletRequest0 = mock(HttpServletRequest.class, new ViolatedAssumptionAnswer());
      Request request0 = RequestResponseFactory.create(httpServletRequest0);
      assertNotNull(request0);
  }
}
