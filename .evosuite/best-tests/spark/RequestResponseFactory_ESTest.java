...
public class RequestResponseFactory_ESTest extends RequestResponseFactory_ESTest_scaffolding {
  ...
  public void test0()  throws Throwable  {
      ...
      doReturn("\"hNxe").when(routeMatch0).getMatchUri();
      doReturn("\"hNxe").when(routeMatch0).getRequestURI();
  ...
  public void test2()  throws Throwable  {
      ...
      try { 
        RequestResponseFactory.create((RouteMatch) null, (HttpServletRequest) null);
